  ...
  return (
    ...
    >
      ...
      <span className="flex-1 min-w-0">
        <span className={'cur-checklist-item font-medium text-[14.5px] leading-snug transition-colors ' + (checked ? 'line-through text-slate-400' : 'text-slate-800')}>
          {item.label}
        </span>
      </span>
    </div>
                    ...
                    return (
                      ...
                      >
                        ...
                        <span className="min-w-0 flex-1">
                          <span className={'cur-checklist-item font-medium text-[14.5px] leading-snug transition-colors ' + (on ? 'text-slate-400' : 'text-slate-800')}>
