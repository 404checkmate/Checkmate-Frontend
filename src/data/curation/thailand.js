const thailand = {
  ...
  "sections": [
    ...
    },
    {
      ...
      "icon": "",
      "title": "환전 & 결제",
      "body": "태국 화폐는<strong> 바트(THB)</strong>으로,<strong> </strong>1바트는 한화 약 40~46원 수준입니다. 환율을 가장 잘 받으려면 <strong>한국에서 달러로 환전한 뒤 현지에서 바트로 환전</strong>하는 방법을 쓰거나, 방콕 시내의 <strong>슈퍼리치(Super Rich)</strong> 같은 사설 환전소를 이용하는 것이 좋습니다. 현지 ATM에서 인출할 수도 있지만 <strong>1회당 약 200~220바트(약 8,000~9,000원)의 수수료</strong>가 붙습니다. 한 번에 큰 금액을 인출하거나 한국에서 충분히 환전해 가는 것이 좋습니다.<br/>관광지, 쇼핑몰, 대형 레스토랑은 카드 결제가 가능하지만, 로컬 야시장, 길거리 음식, 툭툭, 소규모 가게는 현금만 받습니다. 소액권을 넉넉히 챙겨두세요. 카드는 <strong>트래블월렛, 트래블로그(하나은행), 토스뱅크</strong>가 환전 수수료 거의 없어 편리하게 사용 가능합니다. <strong>QR 결제</strong>인 GLN 또한 많이 사용되니 세팅해놓으시면 편합니다.",
