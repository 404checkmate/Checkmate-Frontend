  ...
  "sections": [
    {
      ...
      "icon": "",
      "title": "기후 & 옷차림",
      "body": "태국은 열대 기후로 연중 덥고 습합니다.<br/>여행하기 가장 좋은 시기는 건기(11월~2월)로, 날씨가 맑고 기온도 상대적으로 낮아 관광하기 쾌적합니다. 성수기이기 때문에 숙소와 항공권 가격이 올라가니 미리 예약하는 것이 좋습니다.<br/>우기(5월~10월)에는 오후에 스콜이 내리는 날이 많지만, 대부분 30분~1시간 안에 그치기 때문에 여행이 불가능한 수준은 아닙니다. 다만, 해양레저를 즐길 경우 일정에 차질이 생길 수 있으며, 바다가 건기보다 탁해 시야가 좋지 않을 수 있습니다.<br/>기본적으로 얇고 통기성 좋은 가벼운 옷차림이 적합하며, 우기에는 우산이나 우비를 준비하는 것이 좋습니다.",
    ...
    },
    {
      ...
      "icon": "",
      "title": "환전 & 결제",
      "body": "태국 화폐는 바트(THB)으로, 1바트는 한화 약 40~46원 수준입니다. 환율을 가장 잘 받으려면 한국에서 달러로 환전한 뒤 현지에서 바트로 환전하는 방법을 쓰거나, 방콕 시내의 슈퍼리치(Super Rich) 같은 사설 환전소를 이용하는 것이 좋습니다. 현지 ATM에서 인출할 수도 있지만 1회당 약 200~220바트(약 8,000~9,000원)의 수수료가 붙습니다. 한 번에 큰 금액을 인출하거나 한국에서 충분히 환전해 가는 것이 좋습니다.<br/>관광지, 쇼핑몰, 대형 레스토랑은 카드 결제가 가능하지만, 로컬 야시장, 길거리 음식, 툭툭, 소규모 가게는 현금만 받습니다. 소액권을 넉넉히 챙겨두세요. 카드는 트래블월렛, 트래블로그(하나은행), 토스뱅크가 환전 수수료 거의 없어 편리하게 사용 가능합니다. QR 결제인 GLN 또한 많이 사용되니 세팅해놓으시면 편합니다.",
    ...
    },
    {
      ...
      "icon": "",
      "title": "건강 & 안전",
      "body": "태국의 수질은 한국만큼 좋지 않으므로, 수돗물 대신 생수를 마시는 것이 안전하며 양치할 때도 생수를 이용하는 것을 추천합니다. 식당에서 나오는 얼음도 출처가 불분명하면 빼달라고 하는 것이 좋습니다. 또한 길거리 음식은 태국 여행의 큰 즐거움이지만, 첫날부터 무리하게 먹으면 배탈이 나기 쉽습니다. 처음엔 불에 익힌 음식 위주로 드시고, 가게 앞에 사람이 많은 곳을 선택하면 비교적 안심할 수 있습니다. 석회수나 현지 음식으로 인한 물갈이 및 배탈에 대비하여 지사제를 포함한 소화기계 비상약을 반드시 지참하시기 바랍니다.<br/>자외선이 매우 강하므로 자외선차단제는 SPF50 이상을 준비하고, 야외 활동 전에 꼼꼼히 바르세요. 태국 일부 지역에서 뎅기열이 보고되고 있으므로 모기 기피제를 숙소에서 나가기 전에 필수로 뿌리세요.",
