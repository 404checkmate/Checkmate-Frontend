const japan = {
  ...
  apps: [
    { emoji: '🚇', iconUrl: 'https://www.google.com/s2/favicons?domain=jreast.co.jp&sz=128', name: 'Suica / PASMO', desc: '전철·버스·편의점 결제까지. 애플페이·구글페이로 등록하면 실물 카드 불필요.' },
    { emoji: '🗺️', iconUrl: 'https://www.google.com/s2/favicons?domain=maps.google.com&sz=128', name: 'Google Maps', desc: '오프라인 지도 다운로드 필수. 전철 환승·도보 길찾기 모두 정확해요.' },
