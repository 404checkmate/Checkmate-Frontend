const usa = {
  ...
  apps: [
    { emoji: '🚗', iconUrl: 'https://www.google.com/s2/favicons?domain=uber.com&sz=128', name: 'Uber / Lyft', desc: '대중교통 불편 지역 필수. 미리 설치하고 결제 카드 등록해 두세요.' },
    { emoji: '🗺️', iconUrl: 'https://www.google.com/s2/favicons?domain=maps.google.com&sz=128', name: 'Google Maps', desc: '대중교통·도보·자동차 길찾기 모두 정확. 오프라인 지도도 다운로드하세요.' },
