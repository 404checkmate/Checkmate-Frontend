  ...
  "apps": [
    {
      ...
      "emoji": "🚗",
      "desc": "베트남 대표 차량 호출 앱으로, 요금이 미리 표시되어 편리하게 이동할 수 있습니다. 오토바이 호출(GrabBike)과 차량 호출(GrabCar) 모두 지원합니다.",
  ...
  "checklist": [
    {
      ...
      "items": [
        "베트남 전자비자(E-visa) 신청 ⚠️ 필수",
        "패스트트랙 입국 서비스 예약 (공항 입국 줄 대기 생략)"
      ]
    },
    {
      "cat": "앱 및 사전 예약",
      ...
      "items": [
        "그랩(Grab) 앱 설치 및 결제 수단 등록 — 현지 택시·배달 필수 앱",
        "푸고(Fugo) 앱 설치 — 베트남 버스 예약 앱",
        "구글 맵 오프라인 지도 다운로드",
        "공항 라운지 예약 — 밤 비행 대비, 카드사 혜택 여부 먼저 확인"
      ]
    },
    {
      "cat": "투어 및 액티비티 예약",
      ...
      "items": [
        "바나힐 입장권 예약 — 다낭, 케이블카 포함, 성수기엔 매진 주의",
        "참섬(Cham Island) 스노클링 투어 예약 — 다낭/호이안 출발, 시즌(3~9월) 확인",
        "호이안 야시장 & 등불 유람선 예약 — 매달 14일 보름달 축제 일정 체크",
        "마사지·스파 예약 — 인기 샵은 며칠 전 예약 필수",
    ...
    },
    {
      ...
      "items": [
        "벌레 기피제 (모기 스프레이/패치) ⚠️ 필수 — 뎅기열 주의",
        "정수 필터 또는 생수 구매 계획 — 수돗물 식수 불가"
      ]
    },
    {
      "cat": "의류 및 수영용품",
      ...
      "items": [
        "수영복",
        "아쿠아슈즈 — 참섬 투어·해변 필수",
        "스노클링 장비 — 현지 대여 가능하나 위생 고려 시 개인 지참 추천",
        "비치타올",
        "방수팩 — 스마트폰·귀중품 보호용",
        "우산 또는 우비 ⚠️ 필수 — 스콜(갑작스러운 폭우) 대비",
        "얇은 긴소매 또는 가디건 — 냉방 강한 식당·쇼핑몰 대비",
    ...
    },
    {
      ...
      "items": [
        "메이크업 픽서 스프레이 — 고온 다습한 날씨에 메이크업 유지 도움",
        "여분 비닐봉지 — 우천 시 가방 보호"
      ]
    },
    {
      ...
      "items": [
        "이어플러그 및 안대 — 밤 비행 또는 게스트하우스 숙박 시",
        "여행용 잠금장치 (자물쇠)",
        "긴급 연락처 메모 (한국 대사관 등)"
      ]
    }
