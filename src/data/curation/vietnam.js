  ...
  "sections": [
    {
      ...
      "icon": "☀️",
      "title": "기후 & 옷차림",
      "body": "베트남은 <strong>남북으로 길게 뻗은 나라</strong>라서 어느 도시를 가느냐에 따라 날씨가 완전히 다릅니다. 크게 북부(하노이), 중부(다낭), 남부(호치민)로 나눠서 이해하면 쉽습니다. <br/><strong>하노이(북부)</strong>는 한국처럼 <strong>사계절</strong>이 있습니다. 12~2월은 흐리고 쌀쌀해서 얇은 패딩이나 두꺼운 가디건이 필요하고, 6~8월은 35도를 넘나드는 더위가 이어집니다. <strong>다낭(중부)</strong>은 9~12월이 우기라 비가 자주 오고, 나머지 계절은 맑고 덥습니다. <strong>호치민(남부)</strong>은 사계절 내내 덥고, 5~10월 우기에는 오후마다 <strong>스콜</strong>이 쏟아집니다. <br/>기본적으로 얇고 통기성 좋은 가벼운 옷차림이 적합하며, 우기에는 우산이나 우비를 휴대하는 것이 좋습니다.",
