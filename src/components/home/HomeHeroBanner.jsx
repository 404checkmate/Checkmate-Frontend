...
export default function HomeHeroBanner() {
  return (
    <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-teal-500 to-[#3db4dd] px-5 py-5 shadow-md shadow-teal-900/15 lg:px-8 lg:py-6 xl:rounded-3xl xl:px-12 xl:py-7">
      <div
      ...
      <div className="relative z-10 flex items-center justify-between">
        ...
        <div className="hero-mascot-slide shrink-0">
          <img
            ...
            className="hero-mascot-bob h-28 w-28 object-contain drop-shadow-md lg:h-32 lg:w-32 xl:h-40 xl:w-40"
          />
        </div>
      </div>
    </div>
