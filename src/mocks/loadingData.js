...
export const TIPS = [
  ...
  'TIP: 여권·e티켓 스크린샷은 오프라인으로도 꼭 저장해 두세요! 📎',
  'TIP: 어댑터·보조배터리는 공항 가기 전날 챙기면 스트레스 제로!',
  'TIP: 체크리스트 완료하면 마음만 여행지에 두고 출발하세요 ✈️',
  'TIP: 여행지 가이드에서 비자·환전·현지 꿀팁을 미리 확인해두면 여행이 훨씬 편해져요! 🗺️',
  'TIP: 출국 2~3일 전에 체크리스트를 한 번 더 훑어보면 빠진 준비물이 딱 보여요 👀',
  'TIP: 해외 사용 카드 한 장과 현금을 함께 챙기면 예상 밖 상황도 당황 없이 넘어가요 💳',
]
